    ...
    return [
        ...
        Case("one-hop", "2 one-hop neighbourhood", "Who manufactures HT-233?",
             planner(tool_turn("graph_find_entity", {"text": "HT-233"}, "a"),
                     ...
                     final()), "answered"),
        Case("multi-hop", "3 multi-hop path (flagship)", HERO_Q,
             planner(tool_turn("graph_analyze", {"subject_id": "site_karachi", "analysis": "supply_chain"}, "a"),
                     final()), "answered", contains="chokepoint_status=candidate"),
