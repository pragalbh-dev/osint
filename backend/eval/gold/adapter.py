...
* the **negative gold is separated out and typed**. 38 of the 125 rows are not claims a model should
  ...
  positives would cap a perfect model's recall at 87/125 ≈ 0.70 and blame every candidate for a loader
  artefact. Measured, on the scorer as built: a model emitting exactly the positive gold scores recall
  **1.0000** through this adapter and **0.6960** through the naive load.
