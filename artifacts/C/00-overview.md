...
- **Residual (needs your call):** how aggressively to hunt/name tier-2/3 China-side suppliers — the one
  effort-vs-collection-value knob inside the reachability bound.
...
## Open questions
- **⚠ Deep-tier hunting depth** (needs your call) — how aggressively to name tier-2/3 China-side suppliers;
  the one effort-vs-collection-value knob inside the enrichment reachability bound (above).
